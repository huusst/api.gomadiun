...
router.use("/api",r_Dashboard, r_pengunjung, r_Pengelola, r_Admin, r_wisatawan, r_Auth, r_Desawisata, r_Wisata, r_Kuliner, r_Penginapan, r_Kategori_Kuliner, r_Menu_Kuliner, r_Pesanan);
